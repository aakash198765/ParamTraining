...
console.log("----The eat method is repeated in both Cat and Bear."); 
console.log("Edit the code in the spirit of DRY by moving the eat method to the Animal supertype.----");
