...
console.log("---Create a mixin named glideMixin that defines a method named glide."); 
console.log("Then use the glideMixin to give both bird and boat the ability to glide.--");
